...
// Supplied component (react-bits "LightTunnel"), adapted only to drop the Tailwind
// utility classes from the root element (this project has no Tailwind pipeline) in
// favour of equivalent inline styles. Shader source and WebGL lifecycle are
// untouched — do not replace this with a CSS animation.
...
const LightTunnel: React.FC<LightTunnelProps> = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      antialias: false,
      // This is an ambient edge effect, not the focal image. A conservative
      // DPR keeps two long-running WebGL layers inexpensive on 4K expo panels.
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        // The prop-sync effect enables opacity after every uniform is ready,
        // preventing a single default-purple frame during initialization.
        uOpacity: { value: 0.0 },
